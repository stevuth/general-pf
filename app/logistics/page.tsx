...
export default function LogisticsUnavailable() {
    return (
            ...
            >
                <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                        Our Logistics services are currently undergoing updates. We'll be back soon with improved features and better service!
                    </p>
